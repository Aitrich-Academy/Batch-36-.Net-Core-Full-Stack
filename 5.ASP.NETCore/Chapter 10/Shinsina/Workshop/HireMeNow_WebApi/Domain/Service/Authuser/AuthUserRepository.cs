...
namespace Domain.Service.Authuser
{
    public class AuthUserRepository: IAuthUserRepository
    {
        ...
        public AuthUserRepository(HireMeNowWebApContext dbContext,IMapper _mapper, IConfiguration configuration)
        {
            _context = dbContext;
            mapper = _mapper;
        ...
        public async Task<AuthUser> AddAuthUser(AuthUser authUser)
        {
            ...
            authUser.IdNavigation.Role = (int)Enums.Role.JOB_SEEKER;
...
{
    new Claim(ClaimTypes.Name, user.IdNavigation.FirstName),
    new Claim(ClaimTypes.Email, user.IdNavigation.Email),
    new Claim(ClaimTypes.Sid, user.Id.ToString()),
    new Claim(ClaimTypes.Role, user.IdNavigation.Role.ToString())
};

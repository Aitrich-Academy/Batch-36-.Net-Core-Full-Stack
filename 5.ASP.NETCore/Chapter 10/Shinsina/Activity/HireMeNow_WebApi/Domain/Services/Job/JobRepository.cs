...
namespace Domain.Services.Job
{
    public class JobRepository:IJobRepository
    {
        ...
        public async Task<List<JobPost>> GetJobs()
        {
            ...
            try
            {
                var jobs = await _context.JobPosts.Include(e => e.JobLocation).Include(e => e.Industry).Include(e => e.Company).Include(e => e.PostedByNavigation).Include(e => e.Category).ToListAsync();
                return jobs;
            }
        ...
        {
            return await _context.JobPosts.Where(e => e.Id == companyId && e.Id == jobId).ToListAsync();
        }

...
namespace Domain.Migrations
{
    ...
    [Migration("20260713161252_Injhjhjitial")]
    partial class Injhjhjitial
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.Skill", b =>
                {
                    ...
                    b.HasIndex(new[] { "JobSeekerProfileId" }, "IX_Skill_JobSeekerProfileId");
            ...
            modelBuilder.Entity("Domain.Models.Skill", b =>
                {
                    b.HasOne("Domain.Models.JobSeekerProfile", "JobSeekerProfile")
                        ...
                        .HasForeignKey("JobSeekerProfileId")
                        .IsRequired()
                        .HasConstraintName("FK_Skill_JobSeekerProfile");
